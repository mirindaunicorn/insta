        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav ml-auto">
                    <form class="form-inline mt-2 mt-md-0" method="GET" action="{{route('users.index')}}">
                        <input class="form-control mr-sm-2" type="text" placeholder="Search users" name="search"
                               aria-label="Search users" value="{{\Illuminate\Support\Facades\Request::get('search')}}">
                    </form>
